...
last_word_length = last_word_lenght(word_list)
...
#         valid = name_verification(name_parts)
#
#         if valid:
...
#                 valid_dni = dni_verification(member_dni)
#                 if valid_dni:
#                     # Genero e imprimo el ID del miembro
#                     print("\n        ***** IDENTIFICADOR DE SOCIO GENERADO *****")
#                     id = member_id_generator(name_parts, member_dni)
#
...
print(f"El numero {number} es primo? {prime_number(number)}")"""
...
#     print(f'El factorial de {n} es: {factorial_number}')
#
