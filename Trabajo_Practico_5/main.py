...
while(True):
    ...
    if funciones.login(password_choose,user_choose,intentos):
...
result = funciones.apply_function_to_list(square, original_list)
...
while True:
    number = int(input(f"Ingrese un numero. Para finalizar, escriba 0 o un numero negativo: "))
    if number <= 0:
        break
    else:
